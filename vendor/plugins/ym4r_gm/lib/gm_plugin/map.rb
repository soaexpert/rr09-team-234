  ...
  module GmPlugin 
    ...
    class GMap
      ...
      def self.header(options = {})
        ...
        a = "<script src=\"http://maps.google.com/maps?file=api&amp;v=2.x&amp;key=ABQIAAAAkO8hQT4rf4acdY_RdVf2WRSb6uJFH8ituLuE6RdcmPwyHL5RMxR18-CsJW0oTNFxTK9qSHog4HM1ug&amp;hl=#{options[:hl]}&amp;sensor=#{options[:sensor]}\" type=\"text/javascript\"></script>\n"
